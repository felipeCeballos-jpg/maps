export const EnText = [
  'Burial place',
  'Russia, Moscow, Pyatnitskoye Highway, 6th km, Mitinskoe Cemetery, Section 135, Coordinates: 55.873390, 37.341548',
  'View on Yandex.Maps',
];

export const RuText = [
  'Место захоронения',
  'Россия, Москва, Пятницкое шоссе, 6-й км, Митинское кладбище, участок 135 (координаты: 55.873390, 37.341548)',
...
//export const originalImages = ['./assets/pins.webp'];

export const originalRuImages = [
  './assets/klubok_en.png',
  './assets/dedicated-ru.webp',
  './assets/header-ru.webp',
];

export const originalEnImages = [
  './assets/klubok_ru.png',
  './assets/dedicated-eng.webp',
  './assets/header-eng.webp',
];
